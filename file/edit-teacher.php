...
$gender=$_POST['gender']; 
$sql="update teacher_add set teacher_name=:studentname,teacher_password=:roolid,teacher_email=:studentemail,Gender=:gender where teacher_id=:stid ";
...
$t_id=$_GET['stid'];
$sql="SELECT * FROM teacher_add  WHERE teacher_id='$t_id'";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" value="<?php echo htmlentities($result->teacher_name)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="email" name="emailid" class="form-control" id="email" value="<?php echo htmlentities($result->teacher_email)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->teacher_password)?>" maxlength="5" required="required" autocomplete="off">
</div>
</div>
