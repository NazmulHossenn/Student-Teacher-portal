...
$newpassword=$_POST['newpassword'];
 $username=$_SESSION['tlogin'];
    $sql ="SELECT teacher_password FROM teacher_add WHERE teacher_email=:username and teacher_password=:password";
...
if($query -> rowCount() > 0)
{
$con="update teacher_add set teacher_password=:newpassword where teacher_email=:username";
