...
<div class="row">
  ...
  <div class="content">
    ...
    <label>Select Class </label>
                ...
                $select="SELECT DISTINCT t1.ClassId, t2. *   FROM tblsubjectcombination t1
                INNER JOIN tblclasses t2 ON t1.ClassId=t2.id";
                $com=mysqli_query($conn,$select)or die("Error");
                $select1="SELECT DISTINCT t1.SubjectId, t2. *   FROM tblsubjectcombination t1
                INNER JOIN tblsubjects t2 ON t1.SubjectId=t2.s_id";
                $com3=mysqli_query($conn,$select1);
                
                ?>
                <select class="" name="class" id="input1">
              ...
              foreach($com as $item){
                ...
                <select class="f" name="subject" id="input1" readonly>
                    
                    <?php  
                      foreach($com3 as $item){
                        ?>
...
<p></p>
                        ...
                        if($totalClass<1){
                          echo "No Record Found";
                            ...
                            foreach($comp456 as $item){
                              ...
                              ?>
            <button class="btn btn-primary btn-sm" onclick="genPDF()">Download</button>
    <table class="table" style="text-align:center;width:300px;" id="firstTable">
                          <tr>
  ...
  function genPDF() {
    ...
    <label>Select Class </label>
                ...
                ?>
                <select class="from-control" name="class" class="form-control" id="input1">
              ...
              foreach($com as $item){
                ...
                <select class="from-control" name="subject" class="form-control" id="input1" readonly>
    ...
    <br>
    <button class="btn btn-primary btn-sm" onclick="gen1PDF()">Download </button>
