<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                ...
                                <h6 class="title">Md. Jobayer Hossain</h6>
...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="manageteacher.php"><i class="fa fa fa-server"></i> <span>Manage Teacher</span></a></li>
   ...
   <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="result-report.php"><i class="fa fa fa-server"></i> <span>View Result</span></a></li>
                                        </ul>
                                    </li>
    <!-- <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Attendance</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-attendance.php"><i class="fa fa-bars"></i> <span>Add Attendance</span></a></li>
                                            <li><a href="manageattendance.php"><i class="fa fa fa-server"></i> <span>Manage Attendance</span></a></li>
