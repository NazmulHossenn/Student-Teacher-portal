...
$pass=$_POST['pass'];
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,RollId=:roolid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,pass=:pass,Status=:status where StudentId=:stid ";
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Passwors</label>
<div class="col-sm-10">
<input type="text" min-length="6" name="pass" class="form-control" id="rollid" value="<?php echo htmlentities($result->pass)?>"  required="required" autocomplete="off">
</div>
</div>
