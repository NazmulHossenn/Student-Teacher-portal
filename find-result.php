                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Student Result Automation System</h4>
                                </div>
                            </div>
...
<div class="form-group">
                            <div class="form-group mt-20">
                                <select name="year" id="" class="form-control" required>
                                    <option  value=""   slected disabled>Select Year</option>
                                    <?php
                                        $select="SELECT DISTINCT res_year FROM result_sheet";
                                        $comp=mysqli_query($conn,$select);
                                        foreach($comp as $item){
                                            ?>
                                            <option  value="<?php echo $item['res_year'] ?>"><?php echo $item['res_year'] ?></option>
                                    <?php
